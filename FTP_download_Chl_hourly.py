...
def download_files_for_date_range(ftp, local_root, remote_root, year, month, start_day, end_day):
    for day in range(start_day, end_day + 1):
        local_directory = os.path.join(local_root, str(year), f'{month:02}', f'{day:02}')
        remote_directory = f"/pub/himawari/L3/CHL/021/{year}{month:02}/{day:02}"
...
def main():
    ...
    local_root = '/Users/byxxx/Documents/srdp Chl/himawari/hourly'
    remote_root = "/pub/himawari/L3/CHL/021"

    download_files_for_date_range(ftp, local_root, remote_root, year, month, start_day, end_day)
